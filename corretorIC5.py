...
#adiciona ao lexico
spell.word_frequency.load_words(['omissa', 'botelho', 'itaquera', 'hidrômetro', 'boleto', 'caveirao', 'carioca', 'guanabara', 'acuado', 'atuem', 'maciel', 'macumba', 'rogério', 'coibir', 'ourique', 'cacheado', 'suzano', 'mercadao', 'favelinha', 'mauricio', 'caiçara', 'maicon'])
